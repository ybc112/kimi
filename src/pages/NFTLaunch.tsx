...
const initialForm: FormState = { name: "", symbol: "", description: "", imageURI: "", baseURI: "https://api.kimi-vault.com/nft/", metadataURI: "", maxSupply: "1000", mintPrice: "0.01", maxMintPerWallet: "10", prompt: "" };
...
export default function NFTLaunch() {
  ...
  const fields: Array<[keyof FormState, string]> = [["name", "合集名称"], ["symbol", "Symbol"], ["description", "合集描述"], ["prompt", "图片主题/提示词"], ["maxSupply", "总供应量"], ["mintPrice", "单枚铸造价 BNB"], ["maxMintPerWallet", "单钱包上限"], ["baseURI", "Token 元数据 Base URI"], ["metadataURI", "合集元数据 URI"]];
